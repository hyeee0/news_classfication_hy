...
model = Sequential()
model.add(Embedding(11922, 300, input_length=20)) # 의미에 대한 형태소 개수만큼 학습
...
model.add(GRU(128, activation='tanh', return_sequences=True)) #결과값을 리턴시켜 입력으로 사용 -> return_sequences
